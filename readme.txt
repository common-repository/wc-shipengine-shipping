...
ShipEngine Shipping will help your business to access deeply discounted rates across multiple carriers and display them in the cart and checkout pages, validate addresses before allowing place an order.

== Description ==
ShipEngine Shipping for WooCommerce plugin lets you quickly integrate with hundreds of carriers via [ShipEngine API](https://www.shipengine.com/) and solve your logistics problems by letting you access deeply discounted shipping rates, validating customer shipping address before allowing to place an order and displaying precise real-time shipping rates at the cart and checkout pages.
...
* Ability to add auto-print script to PDF files
...
[PRO Version of the plugin](https://1teamsoftware.com/product/woocommerce-shipengine-shipping-pro/)
